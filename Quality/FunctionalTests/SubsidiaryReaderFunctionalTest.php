<?php
/**
 * SubsidiaryReader test case.
 * @link http://www.phpunit.de/manual/current/en/database.html
 */
class SubsidiaryReaderFunctionalTest extends PHPUnit_Extensions_Database_TestCase {
    ...
    public function init() {
      ...
      $this->oS = new SubsidiaryReader();
    }

    public function testSubsidiaryReader()
    {
        $this->init();
        $this->markTestIncomplete("Need a sample excel file");
    }
